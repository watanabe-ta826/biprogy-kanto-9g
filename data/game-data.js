...
export const introScenario = [
    { text: '賢者（あなた）は自分の生まれた村が滅びてしまいそうだという知らせを聞いた。', image: 'intro_1' },
    { text: '他の村が生成AIを活用して村を豊かにしている中、\n賢者の生まれた村、九関村は生成AIの導入が遅れていて\n他村との競争に負け、衰退の一途をたどっているというのだ。', image: 'intro_1' },
    { text: '賢者：早く…救わなければ', image: 'intro_2', style: { fill: '#ffd700' } },
    { text: '賢者（あなた）は村を救うために立ち上がることを決意し、\n足早に九関村に向かうことにした。', image: 'intro_2' },
    { text: '生成AIを使ってあなたは村を救うことができるだろうか？', image: 'intro_2' },
    { text: '当アプリの目的は「AIリテラシー」を身につけることです。\n\nAIリテラシーとはAIの仕組みや限界を理解し、\n適切に活用できる能力のことを指します。\n\n近年AI技術が急速に発展した今、\nAIリテラシーはすべての人にとって不可欠な力となっています。', image: 'title_background' },
    { text: 'これを身につけることで、\n誤情報や偏見に惑わされず、AIの出力を批判的に読み解く力が養われます。\n\nまた、AIに依存しすぎず、\n人間としての意思決定や倫理的な配慮を保つことができるようになります。', image: 'title_background' },
    { text: 'さらに、仕事や日常生活の中でAIを効果的に活用し、\n自分の可能性を広げることにもつながります。\n\nさあ、AIリテラシーを身につける冒険へ旅立ちましょう！', image: 'title_background' }
];
...
export const chapter1IntroScenario = [
    { text: '賢者は村近くに到着した' },
    { text: '村人： 賢者さま…！おかえりなさい！\n遠くの国で、人助けをしていたのですよね？\nなぜ急に帰ってこられたのですか？', style: { fill: '#add8e6' } },
    { text: '賢者： この村が衰退の一途をたどっていると風のうわさで聞いたのです。\nだから、生成AIを使って村を救いに来たのです。', style: { fill: '#ffd700' } },
    { text: '村人： （不安そうな様子で）生成AIって最近よく聞きますけど\nよくわかんなくて…なんか怖そうですよね？', style: { fill: '#add8e6' } },
    { text: '賢者： まず生成AIとは何かを説明したほうがよさそうですね。', style: { fill: '#ffd700' } },
...
export const chapter3IntroScenario = [
    { text: '生成AIの便利さが評判となり、\n村人たちはあらゆる場面で生成AIに判断を委ねるようになった。\n最初は献立や天気予報だったが、\n次第に服装、会話、進路、恋愛相談までAIに頼るように。\nその結果、村人たちは「自分で判断する力」を失い、\n次第に村中が混乱するようになる。\n賢者は村人たちの様子を見に街へ出た。', image: 'intro_1' },
    { text: 'カイ（若者）：「AIが言ったから、\n今日は誰とも話さない方がいいって…\nそしたらさ、友達とけんかになっちゃったんだよ。\n無視したわけじゃないのに…AIが言ったから…」', image: 'intro_2', style: { fill: '#add8e6' } },
    { text: 'ハナ（おばあちゃん）：「昔はね、天気を見て畑に出てたのよ。\nでも今は、AIが『今日は休んで』って言うから\n今日の予定はトマトを収穫して市場に持っていく予定だったのに\nできなくなっちゃったわ…\n八百屋のミドリさんには今度謝らなきゃ」', image: 'intro_2', style: { fill: '#add8e6' } },
    { text: 'トマリ（子ども）：「今日の遊びも、AIが決めたんだ。\nぼく、ほんとはかくれんぼしたかったけど…\nAIの言うことを聞けば間違いないんでしょ？\nぼくなんだか楽しくないや…」', image: 'intro_2', style: { fill: '#add8e6' } },
    { text: '賢者：「まずい…村人たちが生成AIに頼り切って\n自分で考えることができなくなっている…\nこのままでは繁栄するどころか\n村が生成AIに支配されてしまう…\nみんなにリスクを学んでもらう必要があるな」', image: 'intro_2', style: { fill: '#ffd700' } },
    { text: '賢者は村人たちを集め、\nクイズ形式で生成AIのリスクを学んでもらうことにした。', image: 'intro_1' },
];
...
export const gameData = {
    ...
    scenes: {
        'Chapter1-1Scene': {
            ...
            entities: [
                {
                    type: 'NPC', imageName: 'npc1', x: 400, y: 450, name: '村人A', dialog: ['賢者様、AI、AIって最近よく聞きますが、一体何なんですかい？'], quiz: {
                ...
                {
                    type: 'NPC', imageName: 'npc1', x: 800, y: 450, name: '村人B', dialog: ['AIはどうやって物事を覚えるんでしょうかね？\n人間みたいに学校にでも行くのかしら？'], quiz: {
        ...
        'Chapter1-2Scene': {
            ...
            entities: [
                ...
                {
                    type: 'NPC', imageName: 'npc1', x: 400, y: 450, name: '村人C', dialog: ['最近噂のChatGPTとかいうのは、どんな仕組みで動いてるんでしょう？\n魔法か何かですか？'], quiz: {
                ...
                {
                    type: 'NPC', imageName: 'npc1', x: 800, y: 450, name: '村人D', dialog: ['AIってのは何でもできる万能の道具なんでしょうか？できないこともあるんですか？'], quiz: {
        ...
        'Chapter1-3Scene': {
            ...
            entities: [
                ...
                {
                    type: 'NPC', imageName: 'npc1', x: 400, y: 450, name: '村人E', dialog: ['AIに答えられない質問なんて、本当にあるのかね？いくつか試してみたいもんだ。'], quiz: {
                ...
                {
                    type: 'NPC', imageName: 'npc1', x: 800, y: 450, name: '村人F', dialog: ['この前、AIは「ハルシネーション」？とかいうのを起こすって聞いたんですが、一体どういう意味なんでしょう？'], quiz: {
